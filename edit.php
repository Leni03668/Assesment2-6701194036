    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
           ...
           <?php
                ...
                $data = mysqli_query($koneksi,"select * from nilai where semester='$semester'");
            ...
            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <p> Semester </p> <span><input type="text" name="semester" class="form-control" value="<?php echo $d['semester']; ?>">  </span>                      
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <p> IP </p> <span><input type="text" name="ip" class="form-control" value="<?php echo $d['ip']; ?>">  </span>                      
                                </div>
                            </div>
